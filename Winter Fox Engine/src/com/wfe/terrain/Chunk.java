...
public class Chunk {
	...
	public Chunk(int x, int y, HeightGenerator heightGenerator, int[][] tilesHeight) {
	...
	public void init(HeightGenerator heightGenerator, int[][] tilesHeight, int iterX, int iterY) {
	...
	private void create(int[][] tilesHeight) {
