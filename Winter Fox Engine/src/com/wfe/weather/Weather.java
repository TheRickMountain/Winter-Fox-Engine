...
public class Weather {
	...
	private WeatherFrame[] weatherFrames = {
		...
		new WeatherFrame(4000, new Vector3f(0.94f, 0.23f, 0)),
		new WeatherFrame(7500, new Vector3f(0.9f, 0.9f, 0.9f)),
		new WeatherFrame(12000, new Vector3f(1.0f, 1.0f, 1.0f)),
		new WeatherFrame(16500, new Vector3f(0.9f, 0.9f, 0.9f)),
